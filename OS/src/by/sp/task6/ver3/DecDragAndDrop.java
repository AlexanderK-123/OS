        ...
        MouseMotionListener // For processing mouse drags
{
    ...
    private MyShape currentScribble; // The scribble in progress
    private MyShape beingDragged; // The scribble being dragged
    ...
    public void mousePressed(MouseEvent e) {
        ...
        currentScribble = new MyShape(param, e.getX(), e.getY());
    ...
    public void dragGestureRecognized(DragGestureEvent e) {
        ...
        for (MyShape astroid : shapes) { // Loop through the scribbles
            if (astroid.intersects(rectangle)) {
                ...
                beingDragged = astroid;

                // Next, create a copy that will be the one dragged
                MyShape dragScribble = (MyShape) astroid.clone();
